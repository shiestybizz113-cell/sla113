...
register_universe("empire1", "Empire 1 Pro", "Hybrid Intelligence SaaS — Creator Dashboard, AI Music Creation, Duet Engine, Emotional Grammar, Vocal Logic, Billing, Studio Tools", "/api/empire1", engine="hybrid+lyrica+unity", product="Empire 1 Pro — Hybrid Intelligence SaaS", domain="empire1.cloud")
register_universe("southern", "SouthernLifestyle Game OS", "White Label OS — Full Game Systems, Corporate Identity, Compliance, Admin Identity, Brand Gateway, Fish Shooter + Slots Engine, FMOD Audio, Unity DOTS Physics", "/api/southern", engine="white_os+unity+fmod", product="SouthernLifestyle Game OS", domain="southernlifestyle.org")
register_universe("lyrica3", "Lyrica 3 Pro", "Sonance Pro Ecosystem — SL Universal, Lyria Orchestrator, AI Music Creation, Duet Engine, Emotional Grammar, Vocal Logic, Stem Separation (HTDemucs), VoxCPM Voice Synthesis", "/api/lyrica3", engine="vertex-ai+htdemucs+voxcpm", product="Lyrica 3 Pro — Sonance Pro Ecosystem", domain="lyrica3.com")
